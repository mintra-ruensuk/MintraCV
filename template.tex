...
\cvitem{supervisors}{Matthew N. Dailey, PhD}
\cvitem{description}{
...
Personally, I have been using \texttt{Pomodoro Technique} since last year. It helps me to manage the internal/external interruptions, so that I can see myself more hyper productive.\newline{}%
}
